...
- **Better to have test coverage for UT & intergration cases**

Adding test coverage requirements to the project helps identify areas with insufficient test coverage and prevents incomplete testing.
By enforcing minimum test coverage thresholds, we can detect untested parts of the codebase and avoid merging changes with inadequate test coverage.
